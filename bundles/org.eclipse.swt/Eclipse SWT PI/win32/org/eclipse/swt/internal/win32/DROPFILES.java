...
//	POINT pt; // Drop point. The coordinates depend on fNC.
	public int pt_x;
	public int pt_y;
	public boolean fNC; // Nonclient area flag. If this member is TRUE, pt specifies the screen 
	...
	public boolean fWide; // Value that indicates whether the file contains ANSI or Unicode 
