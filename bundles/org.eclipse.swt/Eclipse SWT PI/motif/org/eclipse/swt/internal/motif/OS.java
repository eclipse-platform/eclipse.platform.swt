...
public static final native int ConnectionNumber(int display);
...
public static final native int XChangeActivePointerGrab(int display, int eventMask, int cursor, int time);
public static final native void XChangeProperty(int display, int w, int property, int type, int format, int mode, int[] data, int nelements);
public static final native void XChangeWindowAttributes(int display, int window, int mask, XSetWindowAttributes attributes);
public static final native int XCheckIfEvent(int display, int event_return, int predicate, int arg);
public static final native boolean XCheckMaskEvent(int display, int mask, int event);
public static final native boolean XCheckWindowEvent(int display, int window, int mask, int event);
...
public static final native int XCreateWindow(int display, int parent, int x, int y, int width, int height, int border_width, int depth, int clazz, int visual, long value_mask, XSetWindowAttributes attributes);
...
public static final native void XDrawPoint(int display, int drawable, int gc, int x, int y);
public static final native boolean XEmptyRegion(int region);
public static final native int XEventsQueued(int display, int mode);
...
public static final native boolean XFilterEvent(int event, int window);
...
public static final native void XFreeStringList(int list);
...
public static final native int XGetWindowProperty(int display, int window, int property, int offset, int length, boolean delete, int req_type, int[] actual_type_return, int[] actual_format_return, int[] nitems_return, int[] bytes_after_return, int[] prop_return);
public static final native int XGrabKeyboard(int display, int grabWindow, int ownerEvents, int pointerMode, int keyboardMode, int time);
public static final native int XGrabPointer(int display, int grabWindow, int ownerEvents, int eventMask, int pointerMode, int keyboardMode, int confineToWindow, int cursor, int time);
...
public static final native void XIntersectRegion(int sra, int srb, int dr_return);
public static final native int XKeysymToKeycode(int display, int keysym);
...
public static final native void XMapWindow(int display, int w);
public static final native int XGetModifierMapping(int display);
public static final native int XGetIconSizes(int display, int w, int[] size_list_return, int[] count_return);
public static final native void XMoveResizeWindow(int display, int w, int x, int y, int width, int height);
public static final native void XOffsetRegion(int r, int dx, int dy);
...
public static final native int XPolygonRegion(short[] points, int n, int fill_rule);
...
public static final native int XQueryBestCursor(int display, int d, int width, int height, int[] width_return, int[] height_return);
public static final native int XQueryPointer(int display, int window, int[] root, int[] child, int[] rootX, int[] rootY, int[] windowX, int[] windowY, int[] mask);
...
public static final native int XReparentWindow(int display, int win, int parent, int x, int y);
public static final native void XResizeWindow(int display, int w, int width, int height);
public static final native int XRootWindowOfScreen(int screen);
public static final native void XSelectInput(int display, int window, int mask);
public static final native int XSendEvent(int display, int window, boolean propagate, int event_mask, int event);
...
public static final native void XSetWMNormalHints(int display, int w, XSizeHints hints);
public static final native void XShapeCombineMask(int display, int dest, int dest_kind, int x_off, int y_off, int src, int op);
public static final native void XShapeCombineRegion(int display, int dest, int dest_kind, int x_off, int y_off, int region, int op);
...
public static final native void XTestFakeButtonEvent(int display, int button, boolean is_press, int delay);
public static final native void XTestFakeKeyEvent(int display, int keycode, boolean is_press, int delay);
public static final native void XTestFakeMotionEvent(int display, int screen_number, int x, int y, int delay);
public static final native boolean XTranslateCoordinates(int display, int src_w, int dest_w, int src_x, int src_y, int[] dest_x_return, int[] dest_y_return, int[] child_return);
public static final native void XUndefineCursor(int display, int window);
public static final native int XUngrabKeyboard(int display, int time);
...
public static final native void XUnmapWindow(int display, int window);
...
public static final native boolean XineramaIsActive(int dpy);
public static final native int XineramaQueryScreens(int dpy, int[] number);
...
public static final native int XmCreateWorkingDialog(int parent, byte[] name, int[] arglist, int argcount);
...
public static final native int XmDragStart(int widget, int event, int[] arglist, int argcount);
...
public static final native void XmImSetFocusValues(int widget, int[] args, int num_args);
public static final native void XmImSetValues(int widget, int[] args, int num_args);
...
public static final native int XmStringBaseline(int fontList, int xmString);
...
public static final native int XmStringConcat(int xmString1, int xmString2);
...
public static final native void XmStringExtent(int fontList, int xmString, short[] width, short[] height);
...
public static final native int XmbTextListToTextProperty(int display, int list, int count, int style, XTextProperty text_prop_return);
public static final native int XmbTextPropertyToTextList(int display, XTextProperty text_prop, int[] list_return, int[] count_return);
...
public static final native int XtAppCreateShell(byte[] appName, byte[] appClass, int widgetClass, int display, int[] argList, int argCount);
public static final native int XtAppGetSelectionTimeout(int appContext);
public static final native void XtAppNextEvent(int appContext, int event);
public static final native boolean XtAppPeekEvent(int appContext, int event);
...
public static final native void XtAppSetFallbackResources(int app_context, int specification_list);
public static final native void XtAppSetSelectionTimeout(int appContext, int timeout);
...
public static final native void XtCallActionProc(int widget, byte[] action, int event, int[] params, int num_params);
...
public static final native boolean XtDispatchEvent(int event);
...
public static final native int XtNameToWidget(int reference, byte[] names);
public static final native int XtOpenDisplay(int xtAppContext, byte[] displayName, byte[] applicationName, byte[] applicationClass, int options, int numOptions, int[] argc, int argv);
...
public static final native void XtRegisterDrawable(int display, int drawable, int widget);
...
public static final native void XtUnregisterDrawable(int display, int drawable);
public static final native int XtWindow(int widget);
public static final native int XtWindowToWidget(int display, int widget);
public static final native void _XmSetMenuTraversal(int menu, boolean traversal);
