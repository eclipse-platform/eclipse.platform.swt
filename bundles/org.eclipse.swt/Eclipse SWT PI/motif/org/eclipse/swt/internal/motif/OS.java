...
//	public static final int XmNUMERIC = 0x3;
	...
	/* byte */
	public static final int XmNancestorSensitive = mallocResource ("ancestorSensitive", 1);
	public static final int XmNanimationStyle = mallocResource ("animationStyle", 1);
	public static final int XmNalignment = mallocResource ("alignment", 1);
	public static final int XmNallowShellResize = mallocResource ("allowShellResize", 1);
	public static final int XmNarrowDirection = mallocResource ("arrowDirection", 1);
	public static final int XmNblendModel = mallocResource ("blendModel", 1);
	public static final int XmNbottomAttachment = mallocResource ("bottomAttachment", 1);
	public static final int XmNchildType = mallocResource ("childType", 1);
	public static final int XmNcomboBoxType = mallocResource ("comboBoxType", 1);
	public static final int XmNdialogStyle = mallocResource ("dialogStyle", 1);
	public static final int XmNcursorPositionVisible = mallocResource ("cursorPositionVisible", 1);
	public static final int XmNdeleteResponse = mallocResource ("deleteResponse", 1);
	...
	public static final int XmNlabelType = mallocResource ("labelType", 1);
	public static final int XmNleftAttachment = mallocResource ("leftAttachment", 1);
	public static final int XmNlistSizePolicy = mallocResource ("listSizePolicy", 1);
	public static final int XmNindicatorOn = mallocResource ("indicatorOn", 1);
	public static final int XmNindicatorType = mallocResource ("indicatorType", 1);
	public static final int XmNnoResize = mallocResource ("noResize", 1);
	public static final int XmNorientation = mallocResource ("orientation", 1);
	public static final int XmNoverrideRedirect = mallocResource ("overrideRedirect", 1);
	public static final int XmNprocessingDirection = mallocResource ("processingDirection", 1);
	public static final int XmNrecomputeSize = mallocResource ("recomputeSize", 1);
	public static final int XmNpushButtonEnabled = mallocResource ("pushButtonEnabled", 1);
	public static final int XmNresizable = mallocResource ("resizable", 1);
	public static final int XmNresizePolicy = mallocResource ("resizePolicy", 1);
	public static final int XmNrightAttachment = mallocResource ("rightAttachment", 1);
	public static final int XmNscrollHorizontal = mallocResource ("scrollHorizontal", 1);
	public static final int XmNscrollVertical = mallocResource ("scrollVertical", 1);
	public static final int XmNselectColor = mallocResource ("selectColor", 1);
	public static final int XmNselectionPolicy = mallocResource ("selectionPolicy", 1);
	public static final int XmNsensitive = mallocResource ("sensitive", 1);
	public static final int XmNseparatorType = mallocResource ("separatorType", 1);
	public static final int XmNset = mallocResource ("set", 1);
	public static final int XmNshadowType = mallocResource ("shadowType", 1);
	public static final int XmNtraversalOn = mallocResource ("traversalOn", 1);
	public static final int XmNtopAttachment = mallocResource ("topAttachment", 1);
	public static final int XmNverifyBell = mallocResource ("verifyBell", 1);
	public static final int XmNwordWrap = mallocResource ("wordWrap", 1);
	public static final int XmNnavigationType = mallocResource ("navigationType", 1);
		
	/* short */
	public static final int XmNarrowSize = mallocResource ("arrowSize", 2);
	public static final int XmNarrowSpacing = mallocResource ("arrowSpacing", 2);
	public static final int XmNborderWidth = mallocResource ("borderWidth", 2);
	public static final int XmNheight = mallocResource ("height", 2);
	public static final int XmNhighlightThickness = mallocResource ("highlightThickness", 2);
	public static final int XmNlistMarginHeight = mallocResource ("listMarginHeight", 2);
	public static final int XmNlistMarginWidth = mallocResource ("listMarginWidth", 2);
	public static final int XmNlistSpacing = mallocResource ("listSpacing", 2);
	public static final int XmNmarginBottom = mallocResource ("marginBottom", 2);
	public static final int XmNmarginHeight = mallocResource ("marginHeight", 2);
	public static final int XmNmarginLeft = mallocResource ("marginLeft", 2);
	public static final int XmNmarginRight = mallocResource ("marginRight", 2);
	public static final int XmNmarginTop = mallocResource ("marginTop", 2);
	public static final int XmNmarginWidth = mallocResource ("marginWidth", 2);
	public static final int XmNpositionIndex = mallocResource ("positionIndex", 2);
	public static final int XmNrows = mallocResource ("rows", 2);
	public static final int XmNshadowThickness = mallocResource ("shadowThickness", 2);
	public static final int XmNshowAsDefault = mallocResource ("showAsDefault", 2);
	public static final int XmNwidth = mallocResource ("width", 2);
	public static final int XmNx = mallocResource ("x", 2);
	public static final int XmNy = mallocResource ("y", 2);
			
	/* int */
	public static final int XmNaccelerator = mallocResource ("accelerator", 4);
	public static final int XmNacceleratorText = mallocResource ("acceleratorText", 4);
	public static final int XmNactivateCallback = mallocResource ("activateCallback", 4);
	public static final int XmNarmCallback = mallocResource ("armCallback", 4);
	public static final int XmNbackground = mallocResource ("background", 4);
	public static final int XmNborderColor = mallocResource ("borderColor", 4);
	public static final int XmNbottomShadowColor = mallocResource ("bottomShadowColor", 4);
	public static final int XmNbrowseSelectionCallback = mallocResource ("browseSelectionCallback", 4);
	public static final int XmNcancelCallback = mallocResource ("cancelCallback", 4);
	public static final int XmNcancelLabelString = mallocResource ("cancelLabelString", 4);
	public static final int XmNcascadingCallback = mallocResource ("cascadingCallback", 4);
	public static final int XmNchildren = mallocResource ("children", 4);
	public static final int XmNclientData = mallocResource ("clientData", 4);
	public static final int XmNcolormap = mallocResource ("colormap", 4);
	public static final int XmNconvertProc = mallocResource ("convertProc", 4);
	public static final int XmNdecrementCallback = mallocResource ("decrementCallback", 4);
	public static final int XmNdefaultActionCallback = mallocResource ("defaultActionCallback", 4);
	public static final int XmNdefaultButtonShadowThickness = mallocResource ("defaultButtonShadowThickness", 4);
	public static final int XmNdialogTitle = mallocResource ("dialogTitle", 4);
	public static final int XmNdirectory = mallocResource ("directory", 4);
	public static final int XmNdirSpec = mallocResource ("dirSpec", 4);
	public static final int XmNdirMask = mallocResource ("dirMask", 4);
	public static final int XmNdragCallback = mallocResource ("dragCallback", 4);
	public static final int XmNdragDropFinishCallback = mallocResource ("dragDropFinishCallback", 4);
	public static final int XmNdragProc = mallocResource ("dragProc", 4);
	public static final int XmNdropFinishCallback = mallocResource ("dropFinishCallback", 4);
	public static final int XmNdropProc = mallocResource("dropProc", 4);
	public static final int XmNeditMode = mallocResource ("editMode", 4);
	public static final int XmNexportTargets = mallocResource ("exportTargets", 4);
	public static final int XmNexposeCallback = mallocResource ("exposeCallback", 4);
	public static final int XmNextendedSelectionCallback = mallocResource ("extendedSelectionCallback", 4);
	public static final int XmNfilterLabelString = mallocResource ("filterLabelString", 4);
	public static final int XmNfont = mallocResource ("font", 4);
	public static final int XmNfontList = mallocResource ("fontList", 4);
	public static final int XmNfontType = mallocResource ("fontType", 4);
	public static final int XmNforeground = mallocResource ("foreground", 4);
	public static final int XmNhelpCallback = mallocResource ("helpCallback", 4);
	public static final int XmNhelpLabelString = mallocResource ("helpLabelString", 4);
	public static final int XmNhighlightColor = mallocResource ("highlightColor", 4);
	public static final int XmNhorizontalScrollBar = mallocResource ("horizontalScrollBar", 4);
	public static final int XmNiconMask = mallocResource ("iconMask", 4);
	public static final int XmNiconPixmap = mallocResource ("iconPixmap", 4);
	public static final int XmNincrement = mallocResource ("increment", 4);
	public static final int XmNincrementCallback = mallocResource ("incrementCallback", 4);
	public static final int XmNitemCount = mallocResource ("itemCount", 4);
	public static final int XmNitems = mallocResource ("items", 4);
	public static final int XmNlabelInsensitivePixmap = mallocResource ("labelInsensitivePixmap", 4);
	public static final int XmNlabelPixmap = mallocResource ("labelPixmap", 4);
	public static final int XmNlabelString = mallocResource ("labelString", 4);
	public static final int XmNlist = mallocResource ("list", 4);
	public static final int XmNmapCallback = mallocResource ("mapCallback", 4);
	public static final int XmNmappedWhenManaged = mallocResource ("mappedWhenManaged", 4);
	public static final int XmNmaximum = mallocResource ("maximum", 4); 
	public static final int XmNmenuBar = mallocResource ("menuBar", 4);
	public static final int XmNmessageString = mallocResource ("messageString", 4);
	public static final int XmNminimum = mallocResource ("minimum", 4);
	public static final int XmNmodifyVerifyCallback = mallocResource ("modifyVerifyCallback", 4);
	public static final int XmNmwmDecorations = mallocResource ("mwmDecorations", 4);
	public static final int XmNmwmInputMode = mallocResource ("mwmInputMode", 4);
	public static final int XmNnumChildren = mallocResource ("numChildren", 4);
	public static final int XmNnumDropTransfers = mallocResource ("numDropTransfers", 4);
	public static final int XmNnumExportTargets = mallocResource ("numExportTargets", 4);
	public static final int XmNnumImportTargets = mallocResource("numImportTargets", 4);
	public static final int XmNmnemonic = mallocResource ("mnemonic", 4);
	public static final int XmNimportTargets = mallocResource("importTargets", 4);
	public static final int XmNokCallback = mallocResource ("okCallback", 4);
	public static final int XmNokLabelString = mallocResource ("okLabelString", 4);
	public static final int XmNoperationCursorIcon = mallocResource ("operationCursorIcon", 4);
	public static final int XmNselectionCallback = mallocResource ("selectionCallback", 4);
	public static final int XmNsourceCursorIcon = mallocResource ("sourceCursorIcon", 4);
	public static final int XmNstateCursorIcon = mallocResource ("stateCursorIcon", 4);
	public static final int XmNsubstitute = mallocResource ("substitute", 4);
	public static final int XmNpageDecrementCallback = mallocResource ("pageDecrementCallback", 4);
	public static final int XmNpageIncrement = mallocResource ("pageIncrement", 4);
	public static final int XmNpageIncrementCallback = mallocResource ("pageIncrementCallback", 4);
	public static final int XmNpattern = mallocResource ("pattern", 4);
	public static final int XmNrenderTable = mallocResource ("renderTable", 4);
	public static final int XmNscaleMultiple = mallocResource ("scaleMultiple", 4);
	public static final int XmNselectedItemCount = mallocResource ("selectedItemCount", 4);
	public static final int XmNselectedItems = mallocResource ("selectedItems", 4);
	public static final int XmNselectedPosition = mallocResource ("selectedPosition", 4);
	public static final int XmNselectionArrayCount = mallocResource ("selectionArrayCount", 4);
	public static final int XmNsliderSize = mallocResource ("sliderSize", 4);
	public static final int XmNsubMenuId = mallocResource ("subMenuId", 4);
	public static final int XmNtabList = mallocResource ("tabList", 4);
	public static final int XmNtextField = mallocResource ("textField", 4);
	public static final int XmNtitle = mallocResource ("title", 4);
	public static final int XmNtitleString = mallocResource ("titleString", 4);
	public static final int XmNtoBottomCallback = mallocResource ("toBottomCallback", 4);
	public static final int XmNtoTopCallback = mallocResource ("toTopCallback", 4);
//	public static final int XmNtopCharacter = mallocResource ("topCharacter", 4);
	public static final int XmNtopItemPosition = mallocResource ("topItemPosition", 4);
	public static final int XmNtopShadowColor = mallocResource ("topShadowColor", 4);
	public static final int XmNtransferProc = mallocResource ("transferProc", 4);
	public static final int XmNtransferStatus = mallocResource ("transferStatus", 4);
	public static final int XmNtroughColor = mallocResource ("troughColor", 4);
	public static final int XmNunmapCallback = mallocResource ("unmapCallback", 4);
	public static final int XmNuserData = mallocResource ("userData", 4);
	public static final int XmNvalue = mallocResource ("value", 4);
	public static final int XmNvalueChangedCallback = mallocResource ("valueChangedCallback", 4);
	public static final int XmNverticalScrollBar = mallocResource ("verticalScrollBar", 4);
	public static final int XmNvisibleItemCount = mallocResource ("visibleItemCount", 4);
	public static final int XmNdropTransfers  = mallocResource ("dropTransfers", 4);
	public static final int XmNshowArrows = mallocResource ("showArrows", 4);
	public static final int XmNspotLocation = mallocResource ("spotLocation", 4);
//	public static final int XNFocusWindow = mallocResource ("focusWindow", 4);
//	public static final int XNInputStyle = mallocResource ("inputStyle", 4);
...
static int mallocResource (String name, int length) {
