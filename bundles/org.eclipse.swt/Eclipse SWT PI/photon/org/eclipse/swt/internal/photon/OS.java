...
public static final native void memmove(int[] address, int point, int size);
public static final native void memmove(int address, int[] point, int size);
public static final native void memmove(int address, PhTile_t point, int size);
public static final native void memmove(PhTile_t address, int point, int size);
public static final native void memmove(PtCallbackInfo_t address, int point, int size);
public static final native void memmove(PhWindowEvent_t address, int point, int size);
public static final native void memmove(byte[] address, int point, int size);
public static final native void memmove(int address, byte[] point, int size);
public static final native void memmove(int address, PhRect_t point, int size);
public static final native void memmove(PhRect_t address, int point, int size);
public static final native void memmove(short[] address, int point, int size);
public static final native void memmove(int address, int point, int size);
public static final native void memmove(int address, PhImage_t point, int size);
public static final native void memmove(PhImage_t address, int point, int size);
public static final native void memmove(FontDetails address, int point, int size);
public static final native void memmove(int address, PhPointerEvent_t point, int size);
public static final native void memmove(PhPointerEvent_t address, int point, int size);
public static final native void memmove(PhEvent_t address, int point, int size);
public static final native void memmove(int address, PhEvent_t point, int size);
public static final native void memmove(PhKeyEvent_t address, int point, int size);
public static final native void memmove(PtScrollbarCallback_t address, int point, int size);
public static final native void memmove(int address, PhArea_t point, int size);
public static final native void memmove(PgAlpha_t address, int point, int size);
public static final native void memmove(int address, PgAlpha_t point, int size);
public static final native void memmove(PtTextCallback_t address, int point, int size);
public static final native void memmove(int address, PtTextCallback_t point, int size);
public static final native void memmove(PgMap_t address, int point, int size);
public static final native void memmove(int address, PhCursorDef_t point, int size);
public static final native void memmove(PhClipHeader address, int point, int size);
public static final native void memmove(byte[] address, PhClipHeader point, int size);
