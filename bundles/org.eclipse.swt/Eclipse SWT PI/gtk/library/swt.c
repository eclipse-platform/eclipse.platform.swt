...
JNIEXPORT void JNICALL Java_org_eclipse_swt_internal_gtk_OS_gtk_1text_1view_1set_1justification
	(JNIEnv *env, jclass that, jint arg0, jint arg1)
{
	DEBUG_CALL("gtk_1text_1view_1set_1justification\n")

	gtk_text_view_set_justification((GtkTextView *)arg0, (GtkJustification)arg1);
}
#endif
