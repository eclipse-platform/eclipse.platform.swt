...
#define gtk_combo_box_get_active_text_LIB "libgtk-x11-2.0.so.0"
...
#define gtk_page_setup_set_paper_size_and_default_margins_LIB "libgtk-x11-2.0.so.0"
...
#define gtk_print_settings_copy_LIB "libgtk-x11-2.0.so.0"
