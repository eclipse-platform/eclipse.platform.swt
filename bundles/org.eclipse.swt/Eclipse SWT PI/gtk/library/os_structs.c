...
typedef struct GInterfaceInfo_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID interface_finalize, interface_data, interface_init;
...
typedef struct GTypeInfo_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID base_init, base_finalize, class_init, class_finalize, class_data, instance_size, n_preallocs, instance_init, value_table, class_size;
} GTypeInfo_FID_CACHE;
...
typedef struct GTypeQuery_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID type_name, class_size, instance_size, type;
...
typedef struct GdkDragContext_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID is_source, source_window, dest_window, targets, actions, suggested_action, action, start_time, protocol;
...
typedef struct GdkEventButton_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID send_event, time, x, y, axes, state, button, device, x_root, y_root, window;
...
typedef struct GdkEventCrossing_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID send_event, subwindow, time, x, y, x_root, y_root, mode, detail, focus, state, window;
...
typedef struct GdkEventExpose_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID send_event, area_x, area_y, area_width, area_height, region, count, window;
...
typedef struct GdkEventKey_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID send_event, time, state, keyval, length, string, hardware_keycode, group, window;
...
typedef struct GdkEventMotion_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID send_event, time, x, y, axes, state, is_hint, device, x_root, y_root, window;
...
typedef struct GdkEventScroll_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID send_event, time, x, y, state, direction, device, x_root, y_root, window;
...
typedef struct GdkEventVisibility_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID send_event, state, window;
...
typedef struct GdkEventWindowState_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID send_event, changed_mask, new_window_state, window;
...
typedef struct GdkGCValues_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID foreground_red, foreground_green, foreground_blue, background_pixel, background_red, background_green, background_blue, font, function, fill, tile, stipple, clip_mask, subwindow_mode, ts_x_origin, ts_y_origin, clip_x_origin, clip_y_origin, graphics_exposures, line_width, line_style, cap_style, join_style, foreground_pixel;
...
typedef struct GdkGeometry_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID min_height, max_width, max_height, base_width, base_height, width_inc, height_inc, min_aspect, max_aspect, win_gravity, min_width;
...
typedef struct GdkWindowAttr_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID event_mask, x, y, width, height, wclass, visual, colormap, window_type, cursor, wmclass_name, wmclass_class, override_redirect, title;
...
typedef struct GtkBorder_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID right, top, bottom, left;
} GtkBorder_FID_CACHE;
...
typedef struct GtkSelectionData_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID target, type, format, data, length, selection;
...
typedef struct PangoAttribute_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID start_index, end_index, klass;
...
typedef struct PangoItem_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID length, num_chars, analysis_shape_engine, analysis_lang_engine, analysis_font, analysis_level, analysis_language, analysis_extra_attrs, offset;
} PangoItem_FID_CACHE;
...
typedef struct PangoLayoutLine_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID start_index, length, runs, layout;
...
typedef struct PangoLogAttr_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID is_mandatory_break, is_char_break, is_white, is_cursor_position, is_word_start, is_word_end, is_sentence_boundary, is_sentence_start, is_sentence_end, is_line_break;
...
typedef struct XAnyEvent_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID send_event, display, window, serial;
} XAnyEvent_FID_CACHE;
...
typedef struct XButtonEvent_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID subwindow, time, x, y, x_root, y_root, state, button, same_screen, root;
...
typedef struct XClientMessageEvent_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID serial, send_event, display, window, message_type, format, data, type;
...
typedef struct XCrossingEvent_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID subwindow, time, x, y, x_root, y_root, mode, detail, same_screen, focus, state, root;
...
typedef struct XExposeEvent_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID y, width, height, count, x;
...
typedef struct XRenderPictureAttributes_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID alpha_map, alpha_x_origin, alpha_y_origin, clip_x_origin, clip_y_origin, clip_mask, graphics_exposures, subwindow_mode, poly_edge, poly_mode, dither, component_alpha, repeat;
...
typedef struct XWindowChanges_FID_CACHE {
	int cached;
	jclass clazz;
	jfieldID y, width, height, border_width, sibling, stack_mode, x;
