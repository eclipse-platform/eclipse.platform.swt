...
public static final synchronized native int call (int function, int arg1);
...
public static final synchronized native void memmove (AtkComponentIface atkComponentIface, int atkComponentIfacePtr);
public static final synchronized native void memmove(int atkComponentIfacePtr, AtkComponentIface atkComponentIface);
...
public static final synchronized native void memmove (AtkTextIface atkTextIface, int atkTextIfacePtr);
public static final synchronized native void memmove(int atkTextIfacePtr, AtkTextIface atkTextIface);
...
public static final synchronized native int call (int func, int p1, int p2, int p3, int p4, int p5);
public static final synchronized native int call (int func, int p1, int p2, int p3, int p4, int p5, int p6);
...
public static final synchronized native short ATK_OBJECT_FACTORY_CLASS_SIZE ();
public static final synchronized native short ATK_OBJECT_FACTORY_SIZE ();
