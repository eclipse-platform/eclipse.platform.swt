...
public static final native int gdk_event_copy(int event);
...
public static final native void gdk_event_handler_set(int func, int data, int notify);
public static final native void gdk_flush();
public static final native void gdk_free_text_list(int list);
...
public static final native boolean gdk_utf8_to_compound_text(byte[] str, int[] encoding, int[] format, int[] ctext, int[] length);
public static final native int gdk_text_property_to_utf8_list  (int encoding, int format, int text, int length,  int[] list);
...
public static final native int gdk_window_get_parent(int window);
...
public static final native void gtk_main_do_event(int event);
...
public static final native int gtk_range_set_increments(int range, double step, double page);
public static final native int gtk_range_set_range(int range, double min, double max);
public static final native int gtk_range_set_value(int range, double value);
