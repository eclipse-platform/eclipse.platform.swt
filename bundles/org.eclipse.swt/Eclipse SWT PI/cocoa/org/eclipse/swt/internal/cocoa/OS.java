...
/** Memmove natives */
public static final native void memmove(int /*long*/ dest, CGPoint src, int size);
public static final native void memmove(CGPoint dest, int /*long*/ src, int size);
public static final native void memmove(int /*long*/ dest, CGRect src, int size);
public static final native void memmove(CGRect dest, int /*long*/ src, int size);
public static final native void memmove(int /*long*/ dest, CGSize src, int size);
public static final native void memmove(CGSize dest, int /*long*/ src, int size);
