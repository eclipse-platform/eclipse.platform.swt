...
public static final native void memcpy(org.eclipse.swt.internal.carbon.Point dest, int[] src, int n);
...
public static final native void memcpy(int dest, short[] src, int n);
public static final native void memcpy(int dest, int src, int n);
