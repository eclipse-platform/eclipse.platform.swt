...
public class SnippetTableColor_Old {
	...
	public static void main(String[] args) {
		...
		var table = new Table_Old(shell, SWT.BORDER | SWT.FULL_SELECTION);
		table.setBackground(gray);
		var column1 = new TableColumn_Old(table, SWT.NONE);
		var column2 = new TableColumn_Old(table, SWT.NONE);
		var column3 = new TableColumn_Old(table, SWT.NONE);
		var item = new TableItem_Old(table, SWT.NONE);
		item.setText(new String[] { "entire", "row", "red foreground" });
		item.setForeground(red);
		item = new TableItem_Old(table, SWT.NONE);
