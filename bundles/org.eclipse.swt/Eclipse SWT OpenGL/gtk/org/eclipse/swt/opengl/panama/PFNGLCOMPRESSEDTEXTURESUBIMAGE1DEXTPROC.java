...
public interface PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC.class, fi, constants$566.PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC$FUNC, "(IIIIIIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    ...
    static PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, jdk.incubator.foreign.MemoryAddress x7) -> {
            try {
                constants$566.PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7);
            } catch (Throwable ex$) {
