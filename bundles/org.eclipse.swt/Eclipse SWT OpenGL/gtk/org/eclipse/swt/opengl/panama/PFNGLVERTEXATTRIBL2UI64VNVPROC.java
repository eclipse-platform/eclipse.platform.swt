...
public interface PFNGLVERTEXATTRIBL2UI64VNVPROC {
    ...
    static MemoryAddress allocate(PFNGLVERTEXATTRIBL2UI64VNVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXATTRIBL2UI64VNVPROC.class, fi, constants$834.PFNGLVERTEXATTRIBL2UI64VNVPROC$FUNC, "(ILjdk/incubator/foreign/MemoryAddress;)V");
    }
    ...
    static PFNGLVERTEXATTRIBL2UI64VNVPROC ofAddress(MemoryAddress addr) {
        return (int x0, jdk.incubator.foreign.MemoryAddress x1) -> {
            try {
                constants$834.PFNGLVERTEXATTRIBL2UI64VNVPROC$MH.invokeExact((Addressable)addr, x0, x1);
            } catch (Throwable ex$) {
