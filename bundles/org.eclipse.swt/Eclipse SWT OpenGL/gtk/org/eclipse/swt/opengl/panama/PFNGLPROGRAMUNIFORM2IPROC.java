...
public interface PFNGLPROGRAMUNIFORM2IPROC {
    ...
    static MemoryAddress allocate(PFNGLPROGRAMUNIFORM2IPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLPROGRAMUNIFORM2IPROC.class, fi, constants$228.PFNGLPROGRAMUNIFORM2IPROC$FUNC, "(IIII)V");
    }
    ...
    static PFNGLPROGRAMUNIFORM2IPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3) -> {
            try {
                constants$228.PFNGLPROGRAMUNIFORM2IPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3);
            } catch (Throwable ex$) {
