...
public interface PFNGLUNIFORM3I64NVPROC {
    ...
    static MemoryAddress allocate(PFNGLUNIFORM3I64NVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM3I64NVPROC.class, fi, constants$457.PFNGLUNIFORM3I64NVPROC$FUNC, "(IJJJ)V");
    }
    ...
    static PFNGLUNIFORM3I64NVPROC ofAddress(MemoryAddress addr) {
        return (int x0, long x1, long x2, long x3) -> {
            try {
                constants$457.PFNGLUNIFORM3I64NVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3);
            } catch (Throwable ex$) {
