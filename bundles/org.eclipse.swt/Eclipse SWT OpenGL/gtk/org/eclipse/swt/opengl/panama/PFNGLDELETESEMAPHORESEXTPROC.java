...
public interface PFNGLDELETESEMAPHORESEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLDELETESEMAPHORESEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLDELETESEMAPHORESEXTPROC.class, fi, constants$661.PFNGLDELETESEMAPHORESEXTPROC$FUNC, "(ILjdk/incubator/foreign/MemoryAddress;)V");
    }
    ...
    static PFNGLDELETESEMAPHORESEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, jdk.incubator.foreign.MemoryAddress x1) -> {
            try {
                constants$661.PFNGLDELETESEMAPHORESEXTPROC$MH.invokeExact((Addressable)addr, x0, x1);
            } catch (Throwable ex$) {
