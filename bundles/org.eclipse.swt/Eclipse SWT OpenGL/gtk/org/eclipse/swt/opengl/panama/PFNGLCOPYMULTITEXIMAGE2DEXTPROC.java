...
public interface PFNGLCOPYMULTITEXIMAGE2DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLCOPYMULTITEXIMAGE2DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOPYMULTITEXIMAGE2DEXTPROC.class, fi, constants$558.PFNGLCOPYMULTITEXIMAGE2DEXTPROC$FUNC, "(IIIIIIIII)V");
    }
    ...
    static PFNGLCOPYMULTITEXIMAGE2DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8) -> {
            try {
                constants$558.PFNGLCOPYMULTITEXIMAGE2DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8);
            } catch (Throwable ex$) {
