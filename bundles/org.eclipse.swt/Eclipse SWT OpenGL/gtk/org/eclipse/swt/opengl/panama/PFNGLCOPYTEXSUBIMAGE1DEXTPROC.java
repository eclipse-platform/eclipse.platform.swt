...
public interface PFNGLCOPYTEXSUBIMAGE1DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLCOPYTEXSUBIMAGE1DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOPYTEXSUBIMAGE1DEXTPROC.class, fi, constants$533.PFNGLCOPYTEXSUBIMAGE1DEXTPROC$FUNC, "(IIIIII)V");
    }
    ...
    static PFNGLCOPYTEXSUBIMAGE1DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5) -> {
            try {
                constants$533.PFNGLCOPYTEXSUBIMAGE1DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5);
            } catch (Throwable ex$) {
