...
public interface PFNGLTEXTURESUBIMAGE1DPROC {
    ...
    static MemoryAddress allocate(PFNGLTEXTURESUBIMAGE1DPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLTEXTURESUBIMAGE1DPROC.class, fi, constants$288.PFNGLTEXTURESUBIMAGE1DPROC$FUNC, "(IIIIIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    ...
    static PFNGLTEXTURESUBIMAGE1DPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, jdk.incubator.foreign.MemoryAddress x6) -> {
            try {
                constants$288.PFNGLTEXTURESUBIMAGE1DPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
