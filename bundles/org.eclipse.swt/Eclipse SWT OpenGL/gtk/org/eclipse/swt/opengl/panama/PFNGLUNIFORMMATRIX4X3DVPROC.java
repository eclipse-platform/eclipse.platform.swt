...
public interface PFNGLUNIFORMMATRIX4X3DVPROC {
    ...
    static MemoryAddress allocate(PFNGLUNIFORMMATRIX4X3DVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORMMATRIX4X3DVPROC.class, fi, constants$212.PFNGLUNIFORMMATRIX4X3DVPROC$FUNC, "(IIBLjdk/incubator/foreign/MemoryAddress;)V");
    }
    ...
    static PFNGLUNIFORMMATRIX4X3DVPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, byte x2, jdk.incubator.foreign.MemoryAddress x3) -> {
            try {
                constants$212.PFNGLUNIFORMMATRIX4X3DVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3);
            } catch (Throwable ex$) {
