...
public class nsIDOMWindowInternal extends nsIDOMWindow {
	...
	static final int LAST_METHOD_ID = nsIDOMWindow.LAST_METHOD_ID + 68;
	...
	public int GetPrompter(int[] aPrompter) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 7, getAddress(), aPrompter);
	}

	public int GetMenubar(int[] aMenubar) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 8, getAddress(), aMenubar);
	}

	public int GetToolbar(int[] aToolbar) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 9, getAddress(), aToolbar);
	}

	public int GetLocationbar(int[] aLocationbar) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 10, getAddress(), aLocationbar);
	}

	public int GetPersonalbar(int[] aPersonalbar) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 11, getAddress(), aPersonalbar);
	}

	public int GetStatusbar(int[] aStatusbar) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 12, getAddress(), aStatusbar);
	}

	public int GetDirectories(int[] directories) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 13, getAddress(), directories);
	}

	public int GetClosed(boolean[] aClosed) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 14, getAddress(), aClosed);
	}

	public int GetCrypto(int[] aCrypto) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 15, getAddress(), aCrypto);
	}

	public int GetPkcs11(int[] aPkcs11) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 16, getAddress(), aPkcs11);
	}

	public int GetControllers(int[] controllers) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 17, getAddress(), controllers);
	}

	public int GetOpener(int[] aOpener) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 18, getAddress(), aOpener);
	}
	...
	public int GetStatus(int status) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 20, getAddress(), status);
	}
	...
	public int GetDefaultStatus(int defaultStatus) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 22, getAddress(), defaultStatus);
	}
	...
	public int GetLocation(int[] aLocation) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 24, getAddress(), aLocation);
	}

	public int GetInnerWidth(int[] aInnerWidth) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 25, getAddress(), aInnerWidth);
	}
	...
	public int GetInnerHeight(int[] aInnerHeight) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 27, getAddress(), aInnerHeight);
	}
	...
	public int GetOuterWidth(int[] aOuterWidth) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 29, getAddress(), aOuterWidth);
	}
	...
	public int GetOuterHeight(int[] aOuterHeight) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 31, getAddress(), aOuterHeight);
	}
	...
	public int GetScreenX(int[] aScreenX) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 33, getAddress(), aScreenX);
	}
	...
	public int GetScreenY(int[] aScreenY) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 35, getAddress(), aScreenY);
	}
	...
	public int GetPageXOffset(int[] aPageXOffset) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 37, getAddress(), aPageXOffset);
	}

	public int GetPageYOffset(int[] aPageYOffset) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 38, getAddress(), aPageYOffset);
	}

	public int GetScrollMaxX(int[] aScrollMaxX) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 39, getAddress(), aScrollMaxX);
	}

	public int GetScrollMaxY(int[] aScrollMaxY) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 40, getAddress(), aScrollMaxY);
	}

	public int GetLength(int[] aLength) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 41, getAddress(), aLength);
	}

	public int GetFullScreen(boolean[] aFullScreen) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 42, getAddress(), aFullScreen);
	}
	...
	public int Alert(int text) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 44, getAddress(), text);
	}

	public int Confirm(int text, boolean[] _retval) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 45, getAddress(), text, _retval);
	}

	public int Prompt(int aMessage, int aInitial, int aTitle, int aSavePassword, int _retval) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 46, getAddress(), aMessage, aInitial, aTitle, aSavePassword, _retval);
	}

	public int Focus() {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 47, getAddress());
	}
	...
	public int MoveTo(int xPos, int yPos) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 54, getAddress(), xPos, yPos);
	}

	public int MoveBy(int xDif, int yDif) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 55, getAddress(), xDif, yDif);
	}

	public int ResizeTo(int width, int height) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 56, getAddress(), width, height);
	}

	public int ResizeBy(int widthDif, int heightDif) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 57, getAddress(), widthDif, heightDif);
	}

	public int Scroll(int xScroll, int yScroll) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 58, getAddress(), xScroll, yScroll);
	}

	public int Open(int url, int name, int options, int[] _retval) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 59, getAddress(), url, name, options, _retval);
	}

	public int OpenDialog(int url, int name, int options, int aExtraArgument, int[] _retval) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 60, getAddress(), url, name, options, aExtraArgument, _retval);
	}
	...
	public int UpdateCommands(int action) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 62, getAddress(), action);
	}

	public int Escape(int str, int _retval) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 63, getAddress(), str, _retval);
	}
	...
	public int Find(int str, boolean caseSensitive, boolean backwards, boolean wrapAround, boolean wholeWord, boolean searchInFrames, boolean showDialog, boolean[] _retval) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 65, getAddress(), str, caseSensitive, backwards, wrapAround, wholeWord, searchInFrames, showDialog, _retval);
	}

	public int Atob(int aAsciiString, int _retval) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 66, getAddress(), aAsciiString, _retval);
	}

	public int Btoa(int aBase64Data, int _retval) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 67, getAddress(), aBase64Data, _retval);
	}

	public int GetFrameElement(int[] aFrameElement) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 68, getAddress(), aFrameElement);
	}
}