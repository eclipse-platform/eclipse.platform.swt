...
public class nsIDOMWindowInternal extends nsIDOMWindow {
	...
	public int Confirm(int text, boolean[] retVal) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 46, getAddress(), text, retVal);
	}

	public int Prompt(int aMessage, int aInitial, int aTitle, int aSavePassword, int retVal) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 47, getAddress(), aMessage, aInitial, aTitle, aSavePassword, retVal);
	}
	...
	public int OpenDialog(int url, int name, int options, int aExtraArgument, int[] retVal) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 61, getAddress(), url, name, options, aExtraArgument, retVal);
	}
	...
	public int Escape(int str, int retVal) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 64, getAddress(), str, retVal);
	}

	public int Unescape(int str, int retVal) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 65, getAddress(), str, retVal);
	}

	public int Find(int str, boolean caseSensitive, boolean backwards, boolean wrapAround, boolean wholeWord, boolean searchInFrames, boolean showDialog, boolean[] retVal) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 66, getAddress(), str, caseSensitive, backwards, wrapAround, wholeWord, searchInFrames, showDialog, retVal);
	}

	public int Atob(int aAsciiString, int retVal) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 67, getAddress(), aAsciiString, retVal);
	}

	public int Btoa(int aBase64Data, int retVal) {
		return XPCOM.VtblCall(super.LAST_METHOD_ID + 68, getAddress(), aBase64Data, retVal);
	}
