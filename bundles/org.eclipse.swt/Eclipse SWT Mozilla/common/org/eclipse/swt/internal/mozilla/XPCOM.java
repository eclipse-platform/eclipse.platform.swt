...
public static final native int nsEmbedCString_new(byte[] aString, int length);
public static final native void nsEmbedCString_delete(int ptr);
public static final native int nsEmbedCString_Length(int ptr);
public static final native int nsEmbedCString_get(int ptr);
...
public static final native int nsEmbedString_new(char[] aString);
public static final native void nsEmbedString_delete(int ptr);
public static final native int nsEmbedString_Length(int ptr);
public static final native int nsEmbedString_get(int ptr);
public static final native boolean nsEmbedString_Equals(int ptr, int other);
