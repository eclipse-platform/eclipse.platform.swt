...
public void setFont (Font font){
	...
	Font newFont = (font == null ? font : Font.win32_new(font, getFontZoom()));
...
public void setFont (int index, Font font) {
	...
	cellFont [index] = font == null ? font : Font.win32_new(font, getFontZoom());
...
private static void handleDPIChange(Widget widget, int newZoom, float scalingFactor) {
	...
	if (cellFonts != null) {
		for (int index = 0; index < cellFonts.length; index++) {
			...
			cellFonts[index] = cellFont == null ? null : Font.win32_new(cellFont, tableItem.getFontZoom());
		}
	}
}
}
