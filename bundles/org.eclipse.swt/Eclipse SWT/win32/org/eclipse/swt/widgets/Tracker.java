...
Rectangle [] getRectanglesInPixels () {
	...
	for (int i = 0; i < rectangles.length; i++) {
		...
		result [i] = new Rectangle.OfFloat (current.x, current.y, current.width, current.height);
	}
	return result;
}
...
void setRectanglesInPixels (Rectangle [] rectangles) {
	...
	for (int i = 0; i < rectangles.length; i++) {
		...
		this.rectangles [i] = new Rectangle.OfFloat (current.x, current.y, current.width, current.height);
	}
