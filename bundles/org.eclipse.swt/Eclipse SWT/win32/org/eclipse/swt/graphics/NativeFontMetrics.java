 ...
 *      information</a>
 */
public final class NativeFontMetrics extends FontMetricsHandle {

	/**
	 * On Windows, handle is a Win32 TEXTMETRIC struct (Warning: This field is
	 * platform dependent)
	 * <p>
	...
	public boolean equals(Object object) {
		if (object == this)
			return true;
		if (!(object instanceof NativeFontMetrics))
			return false;
		TEXTMETRIC metric = ((NativeFontMetrics) object).handle;
...
//		handle.tmFirstChar ^ handle.tmLastChar ^ handle.tmDefaultChar ^ handle.tmBreakChar ^
	 ...
	 * </p>
	 *
	 * @param handle     the <code>TEXTMETRIC</code> containing information about a
	 *                   font
	 * @param nativeZoom the native zoom of the monitor for which Font Metrics is
	 *                   created
	 ...
	 */
	public static NativeFontMetrics win32_new(TEXTMETRIC handle, int nativeZoom) {
		NativeFontMetrics fontMetrics = new NativeFontMetrics();
