...
public class Caret extends Widget {
	...
	Image image;
	Font font;
	// blinking caret causes currently too much redrawing, this decreases the
	// performance
	...
	public Caret(Canvas parent, int style) {
		...
		parent.addListener(SWT.FocusIn, l);
		parent.addListener(SWT.FocusOut, l);
	...
	public static void setHeight(Caret caretToRefresh, int height) {
		caretToRefresh.height = height;
	}
