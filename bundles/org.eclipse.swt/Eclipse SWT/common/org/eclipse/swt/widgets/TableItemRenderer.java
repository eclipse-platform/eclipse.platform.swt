...
public class TableItemRenderer {
	...
	private static int leftMargin = 3;
	private static int rightMargin = DEFAULT_MARGIN;
	private static int topMargin = DEFAULT_MARGIN_UP_DOWN;
	private static int bottomMargin = DEFAULT_MARGIN_UP_DOWN;
	...
	private Map<Integer, Point> computedCellSizes = new HashMap<>();
	...
	public Point computeCellSize(int colIndex) {
		...
		int height = this.topMargin + this.bottomMargin;
		int width = this.leftMargin + this.rightMargin;
