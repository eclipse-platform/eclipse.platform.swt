...
public class TreeColumn extends Item {
	...
	private TreeColumnRenderer renderer = new TreeColumnRenderer(this);
	...
	int getHeight() {
		...
		if (this.height == -1) {
			this.height = TreeColumnRenderer.guessColumnHeight(this);
		}
	...
	Point getLocation() {
		...
		if (getParent().getHorizontalBar() != null) {
	...
	private void calculateLocation() {
		...
		if (index == 0) {
			if (getParent().getHorizontalBar() != null)
				...
				this.horizontalShiftAtCalculation = 0;
