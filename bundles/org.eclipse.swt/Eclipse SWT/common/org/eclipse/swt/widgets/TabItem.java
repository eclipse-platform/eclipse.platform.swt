 ...
 * </p>
 *
 * @see <a href="http://www.eclipse.org/swt/snippets/#ctabfolder">TabFolder,
 *      CTabItem snippets</a>
 ...
 * </p>
 *
 * @param parent a TabFolder which will be the parent of the new instance
 *               (cannot be null)
...
/**
 * Returns <code>true</code> if the item will be rendered in the visible area of
 * the TabFolder. Returns false otherwise.
 *
 * @return <code>true</code> if the item will be rendered in the visible area of
 *         the TabFolder. Returns false otherwise.
 *
 * @exception SWTException
 *                         <ul>
...
public void setFont(Font font){
	...
	this.font = font;
	parent.updateFolder(TabFolder.UPDATE_TAB_HEIGHT | TabFolder.REDRAW_TABS);
}
...
public void setForeground(Color color) {
	...
	foreground = color;
	parent.updateFolder(TabFolder.REDRAW_TABS);
}
...
/**
 * Sets to <code>true</code> to indicate that the receiver's close button should
 * be shown. If the parent (TabFolder) was created with SWT.CLOSE style,
