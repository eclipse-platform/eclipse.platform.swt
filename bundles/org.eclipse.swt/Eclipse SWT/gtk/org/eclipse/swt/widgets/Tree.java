	...
	if (eventNumber == 0) {
		...
		switch (type) {
			...
			case OS.GDK_FOCUS_CHANGE: {
				...
				* shell from inside the "tree_select_row" signal, the tree does not
				* get the mouse up and does not release grabs.  The fix is to release
				* the grabs when focus is lost.
				*/
