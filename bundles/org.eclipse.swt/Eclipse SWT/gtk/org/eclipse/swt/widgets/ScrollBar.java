...
public boolean getVisible () {
	...
	if ((style & SWT.HORIZONTAL) != 0) {
		return hsp [0] != (OS.GTK_POLICY_NEVER|OS.GTK_POLICY_EXTERNAL) && OS.gtk_widget_get_visible (handle);
	} else {
		return vsp [0] != (OS.GTK_POLICY_NEVER|OS.GTK_POLICY_EXTERNAL) && OS.gtk_widget_get_visible (handle);
	}
}
