...
//	static final int RESIZED				= 1<<14;
	...
	/* GTK signals data */
	static int SIGNAL_DATA = 1;
	static final int ACTIVATE = SIGNAL_DATA++;
	static final int BUTTON_PRESS_EVENT = SIGNAL_DATA++;
	static final int BUTTON_RELEASE_EVENT = SIGNAL_DATA++;
	static final int CHANGED = SIGNAL_DATA++;
	static final int CLICKED = SIGNAL_DATA++;
	static final int COMMIT = SIGNAL_DATA++;
	static final int CONFIGURE_EVENT = SIGNAL_DATA++;
	static final int DELETE_EVENT = SIGNAL_DATA++;
	static final int DELETE_RANGE = SIGNAL_DATA++;
	static final int DELETE_TEXT = SIGNAL_DATA++;
	static final int ENTER_NOTIFY_EVENT = SIGNAL_DATA++;
	static final int EVENT = SIGNAL_DATA++;
	static final int EVENT_AFTER = SIGNAL_DATA++;
	static final int EXPOSE_EVENT = SIGNAL_DATA++;
	static final int FOCUS = SIGNAL_DATA++;
	static final int FOCUS_IN_EVENT = SIGNAL_DATA++;
	static final int FOCUS_OUT_EVENT = SIGNAL_DATA++;
	static final int HIDE = SIGNAL_DATA++;
	static final int INSERT_TEXT = SIGNAL_DATA++;
	static final int KEY_PRESS_EVENT = SIGNAL_DATA++;
	static final int KEY_RELEASE_EVENT = SIGNAL_DATA++;
	static final int LEAVE_NOTIFY_EVENT = SIGNAL_DATA++;
	static final int MAP_EVENT = SIGNAL_DATA++;
	static final int MNEMONIC_ACTIVATE = SIGNAL_DATA++;
	static final int MOTION_NOTIFY_EVENT = SIGNAL_DATA++;
	static final int POPUP_MENU = SIGNAL_DATA++;
	static final int PREEDIT_CHANGED = SIGNAL_DATA++;
	static final int REALIZE = SIGNAL_DATA++;
	static final int ROW_ACTIVATED = SIGNAL_DATA++;
	static final int SELECT = SIGNAL_DATA++;
	static final int SHOW = SIGNAL_DATA++;
	static final int SHOW_HELP = SIGNAL_DATA++;
	static final int SIZE_ALLOCATE = SIGNAL_DATA++;
	static final int SWITCH_PAGE = SIGNAL_DATA++;
	static final int TEST_COLLAPSE_ROW = SIGNAL_DATA++;
	static final int TEST_EXPAND_ROW = SIGNAL_DATA++;
	static final int TOGGLED = SIGNAL_DATA++;
	static final int UNMAP_EVENT = SIGNAL_DATA++;
	static final int UNREALIZE = SIGNAL_DATA++;
	static final int VALUE_CHANGED = SIGNAL_DATA++;
	static final int WINDOW_STATE_EVENT = SIGNAL_DATA++;
