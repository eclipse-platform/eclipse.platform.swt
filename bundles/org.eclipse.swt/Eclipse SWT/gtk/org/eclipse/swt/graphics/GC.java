...
void checkGC (int mask) {
	...
	if ((state & LINE_WIDTH) != 0) {
		Cairo.cairo_set_line_width(cairo, data.lineWidth == 0 ? GtkDPIUtil.autoScaleUp(drawable, 1) : data.lineWidth);
...
public void copyArea(Image image, int x, int y) {
	...
	Point loc = GtkDPIUtil.autoScaleUp(drawable, new Point(x, y));
...
public void copyArea(int srcX, int srcY, int width, int height, int destX, int destY) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	Rectangle src = GtkDPIUtil.autoScaleUp(drawable, new Rectangle(srcX, srcY, width, height));
	Point dest = GtkDPIUtil.autoScaleUp(drawable, new Point(destX, destY));
...
public void copyArea(int srcX, int srcY, int width, int height, int destX, int destY, boolean paint) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	Rectangle srcLoc = GtkDPIUtil.autoScaleUp(drawable, new Rectangle(srcX, srcY, width, height));
	Point destLoc = GtkDPIUtil.autoScaleUp(drawable, new Point(destX, destY));
...
public void drawArc(int x, int y, int width, int height, int startAngle, int arcAngle) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	Rectangle loc = GtkDPIUtil.autoScaleUp(drawable, new Rectangle(x, y, width, height));
...
public void drawImage(Image image, int srcX, int srcY, int srcWidth, int srcHeight, int destX, int destY, int destWidth, int destHeight) {
	...
	if (image == null) SWT.error(SWT.ERROR_NULL_ARGUMENT);
	if (image.isDisposed()) SWT.error(SWT.ERROR_INVALID_ARGUMENT);
	Rectangle destRect = GtkDPIUtil.autoScaleUp(drawable, new Rectangle(destX, destY, destWidth, destHeight));
...
public void drawLine(int x1, int y1, int x2, int y2) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	Point loc1 = GtkDPIUtil.autoScaleUp(drawable, new Point(x1, y1));
	Point loc2 = GtkDPIUtil.autoScaleUp(drawable, new Point(x2, y2));
...
public void drawOval(int x, int y, int width, int height) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	Rectangle rect = GtkDPIUtil.autoScaleUp(drawable, new Rectangle(x, y, width, height));
...
public void drawPolygon(int[] pointArray) {
	...
	int [] scaledPointArray = GtkDPIUtil.autoScaleUp(drawable, pointArray);
...
public void drawRectangle(Rectangle rect) {
	...
	drawRectangleInPixels(GtkDPIUtil.autoScaleUp(drawable, rect));
}
...
public void drawRoundRectangle(int x, int y, int width, int height, int arcWidth, int arcHeight) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	Rectangle rect = GtkDPIUtil.autoScaleUp(drawable, new Rectangle(x, y, width, height));
	Point arcSize = GtkDPIUtil.autoScaleUp(drawable, new Point(arcWidth, arcHeight));
...
public void fillRectangle(Rectangle rect) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	if (rect == null) SWT.error(SWT.ERROR_NULL_ARGUMENT);
	fillRectangleInPixels(GtkDPIUtil.autoScaleUp(drawable, rect));
}
...
public Rectangle getClipping() {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	return GtkDPIUtil.autoScaleDown(drawable, getClippingInPixels());
}
...
public FontMetrics getFontMetrics() {
	...
	int ascentInPoints = GtkDPIUtil.autoScaleDown(drawable, OS.PANGO_PIXELS(ascent));
	fm.ascentInPoints = ascentInPoints;
	int heightInPoints = GtkDPIUtil.autoScaleDown(drawable, OS.PANGO_PIXELS(ascent + descent));
	fm.descentInPoints = heightInPoints - ascentInPoints;
	fm.averageCharWidthInPoints = GtkDPIUtil.autoScaleDown(drawable, OS.PANGO_PIXELS(OS.pango_font_metrics_get_approximate_char_width(metrics)));
...
public LineAttributes getLineAttributes() {
	...
	attributes.width = GtkDPIUtil.autoScaleDown(drawable, attributes.width);
	return attributes;
}
...
public int getLineWidth() {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	return (int)GtkDPIUtil.autoScaleDown(drawable, data.lineWidth);
}
...
public void setClipping(int x, int y, int width, int height) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	setClippingInPixels(GtkDPIUtil.autoScaleUp(drawable, x), GtkDPIUtil.autoScaleUp(drawable, y), GtkDPIUtil.autoScaleUp(drawable, width), GtkDPIUtil.autoScaleUp(drawable, height));
}
...
public void setClipping(Rectangle rect) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	setClippingInPixels(GtkDPIUtil.autoScaleUp(drawable, rect));
}
...
public void setLineAttributes(LineAttributes attributes) {
	...
	attributes.width = GtkDPIUtil.autoScaleUp(drawable, attributes.width);
...
public void setLineWidth(int lineWidth) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	setLineWidthInPixels(GtkDPIUtil.autoScaleUp(drawable, lineWidth));
}
...
public Point stringExtent(String string) {
	return GtkDPIUtil.autoScaleDown(drawable, stringExtentInPixels(string));
}
...
public Point textExtent(String string) {
	return GtkDPIUtil.autoScaleDown(drawable, textExtentInPixels(string));
}
...
public Point textExtent(String string, int flags) {
	if (handle == 0) SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
	if (string == null) SWT.error(SWT.ERROR_NULL_ARGUMENT);
	return GtkDPIUtil.autoScaleDown(drawable, textExtentInPixels(string, flags));
}
