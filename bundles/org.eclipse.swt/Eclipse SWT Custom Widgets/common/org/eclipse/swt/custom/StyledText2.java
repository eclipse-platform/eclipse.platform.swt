...
public class StyledText2 extends Canvas {
	...
	*/
	...
	static class DisplayRenderer extends StyledTextRenderer {
		private StyledText2 parent;			// used to get content and styles during rendering
	 ...
	 */
	DisplayRenderer(Device device, Font regularFont, StyledText2 parent, int tabLength) {
