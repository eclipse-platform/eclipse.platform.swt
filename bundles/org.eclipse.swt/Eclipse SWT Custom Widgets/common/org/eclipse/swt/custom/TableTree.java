...
public class TableTree extends Composite {
	...
	public TableTree(Composite parent, int style) {
		...
		table.addListener(SWT.MouseDown, e -> onMouseDown(e));

		table.addListener(SWT.Selection, e -> onSelection(e));

		table.addListener(SWT.DefaultSelection, e -> onSelection(e));

		addListener(SWT.Dispose, e -> onDispose());

		addListener(SWT.Resize, e -> onResize());

		addListener(SWT.FocusIn, e -> onFocusIn());
	 ...
	 *                     disposed</li>
	 *
	 *                     <li>ERROR_CANNOT_GET_SELECTION when the operation
	 *                     fails</li>
	 *
	 *                     </ul>
	 *
	 ...
	 *                     disposed</li>
	 *
	 *                     <li>ERROR_MENU_NOT_POP_UP when the menu is not a
	 *                     POP_UP</li>
	 *
