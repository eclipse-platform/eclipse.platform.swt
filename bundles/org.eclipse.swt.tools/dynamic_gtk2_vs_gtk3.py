...
def find_gtk_version_functions(custom_str, gtk2_str, gtk30_str, gtk3x_str):
...
if __name__ == "__main__":
    ...
    find_gtk_version_functions(os_custom_str, gtk2functions, gtk30functions, gtk3xfunctions)
