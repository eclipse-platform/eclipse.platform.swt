...
public class Bug490713_MaximizedShellTest {
	...
	public static void main(String[] args) {
		...
		bMaximize.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> shell2.setMaximized(true)));
		Button bMinimize=new Button(shell, SWT.PUSH);
		bMinimize.setText("Unmaximize");
		bMinimize.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> shell2.setMaximized(false)));
		Button bShow=new Button(shell, SWT.PUSH);
		bShow.setText("Show");
		bShow.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> shell2.setVisible(true)));
		Button bHide=new Button(shell, SWT.PUSH);
		bHide.setText("Hide");
		bHide.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> shell2.setVisible(false)));

		Button bIsMaxmized=new Button(shell, SWT.PUSH);
		bIsMaxmized.setText("Is 2 Shell Maximized");
		bIsMaxmized.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
