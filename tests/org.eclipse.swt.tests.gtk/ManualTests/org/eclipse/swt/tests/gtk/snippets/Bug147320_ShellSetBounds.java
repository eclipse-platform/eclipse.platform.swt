...
public class Bug147320_ShellSetBounds {
	...
	static final Rectangle[] DIMENSIONS = { new Rectangle(520, 367, 240, 290), new Rectangle(520, 320, 240, 320),
			new Rectangle(320, 272, 640, 480), new Rectangle(240, 212, 800, 600) };
