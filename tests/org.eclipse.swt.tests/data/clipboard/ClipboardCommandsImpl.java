...
import clipboard.ClipboardTest.FileListSelection;
import clipboard.ClipboardTest.HtmlSelection;
import clipboard.ClipboardTest.ImageSelection;
import clipboard.ClipboardTest.MyTypeSelection;
import clipboard.ClipboardTest.RtfSelection;
import clipboard.ClipboardTest.UrlSelection;
...
public class ClipboardCommandsImpl extends UnicastRemoteObject implements ClipboardCommands {
	...
	public String getRtfContents() throws RemoteException {
		Object contents = getContents(CLIPBOARD, "getRtfContents", ClipboardTest.RTF_InputStream);
	...
	public String getHtmlContents() throws RemoteException {
		Object contents = getContents(CLIPBOARD, "getHtmlContents", ClipboardTest.HTML_InputStream);
		if (!(contents instanceof InputStream stream)) {
			return null;
		}
		try (stream) {
	...
	public byte[] getUrlContents() throws RemoteException {
		Object contents = getContents(CLIPBOARD, "getUrlContents", ClipboardTest.URL_InputStream);
		if (!(contents instanceof InputStream stream)) {
			return null;
		}
		try (stream) {
	...
	public byte[] getMyTypeContents() throws RemoteException {
		Object contents = getContents(CLIPBOARD, "getMyTypeContents", ClipboardTest.MyType_InputStream);
		if (!(contents instanceof InputStream stream)) {
			return null;
		}
		try (stream) {
	...
	public byte[] getImageContents() throws RemoteException {
		...
		if (!(contents instanceof BufferedImage image)) {
			return null;
		}
