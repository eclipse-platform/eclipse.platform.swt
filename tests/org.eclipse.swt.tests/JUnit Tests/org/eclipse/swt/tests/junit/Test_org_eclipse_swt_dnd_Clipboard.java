...
//		SwtTestUtil.processEvents(100, null);
	...
	@ParameterizedTest
	@MethodSource("supportedClipboardIds")
	public void test_LocalClipboard(int clipboardId) throws Exception {
		openAndFocusShell();
	...
	public void test_setContents(int clipboardId) throws Exception {
		...
		openAndFocusRemote();
		// TODO: I don't think we need this wait, if tests pass, delete this commented
		// out code
//		SwtTestUtil.processEvents(1000,
//				() -> helloWorld.equals(SwtTestUtil.runOperationInThread(() -> remote.getStringContents(clipboardId))));
	...
	public void test_getContents(int clipboardId) throws Exception {
		...
		openAndFocusShell();
// TODO: I don't think we need this wait, if tests pass, delete this commented out code
//		SwtTestUtil.processEvents(1000, () -> {
//			return helloWorld.equals(clipboard.getContents(textTransfer, clipboardId));
//		});
		assertEquals(helloWorld, clipboard.getContents(textTransfer, clipboardId));
	}
...
//		CompletableFuture<Object>[] futureHolder = (CompletableFuture<Object>[]) new CompletableFuture<?>[] {null};
//		SwtTestUtil.processEvents(1000, () -> {
//			if (futureHolder[0] == null) {
//				futureHolder[0] = clipboard.getContentsAsync(textTransfer, clipboardId);
//			}
//			if (futureHolder[0].isDone()) {
//				Object get;
//				try {
//					get = futureHolder[0].get();
//				} catch (InterruptedException | ExecutionException e) {
//					// try again
//					get = null;
//				}
//				if (helloWorld.equals(get)) {
//					return true;
//				} else {
//					futureHolder[0] = null;
//				}
...
//		});
	...
	public void test_getContentsBothClipboards() throws Exception {
		...
		// out code
//SwtTestUtil.processEvents(1000, () -> {
//			return helloWorldClipboard.equals(clipboard.getContents(textTransfer, DND.CLIPBOARD))
//					&& helloWorldSelection.equals(clipboard.getContents(textTransfer, DND.SELECTION_CLIPBOARD));
//		});
	...
	public void test_setContentsBothClipboards() throws Exception {
		...
		// TODO: I don't think we need this wait, if tests pass, delete this commented
		// out code
//		SwtTestUtil.processEvents(1000, () -> helloWorldClipboard
//				.equals(SwtTestUtil.runOperationInThread(() -> remote.getStringContents(DND.CLIPBOARD)))
//				&& helloWorldSelection.equals(
