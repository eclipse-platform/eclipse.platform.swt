...
class SystemTab extends Tab {
	...
	void addTableElements () {
		...
		hmap.put(SWT.COLOR_BLUE, "COLOR_BLUE");
		hmap.put(SWT.COLOR_DARK_BLUE, "COLOR_DARK_BLUE");
		hmap.put(SWT.COLOR_CYAN, "COLOR_CYAN");
		hmap.put(SWT.COLOR_DARK_CYAN, "COLOR_DARK_CYAN");
		hmap.put(SWT.COLOR_MAGENTA, "COLOR_MAGENTA");
		hmap.put(SWT.COLOR_DARK_MAGENTA, "COLOR_DARK_MAGENTA");
		hmap.put(SWT.COLOR_GRAY, "COLOR_GRAY");
		hmap.put(SWT.COLOR_DARK_GRAY, "COLOR_DARK_GRAY");
