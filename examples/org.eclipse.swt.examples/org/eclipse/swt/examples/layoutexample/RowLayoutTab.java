...
class RowLayoutTab extends Tab {
	...
	void createControlWidgets () {
		...
		marginLeft.addTraverseListener(new TraverseListener() {
       		public void keyTraversed (TraverseEvent event) {
				if (event.detail == SWT.TRAVERSE_TAB_NEXT) 
					resetEditors ();
				if (event.detail == SWT.TRAVERSE_RETURN) {
		...
		marginTop.addTraverseListener(new TraverseListener() {
       		public void keyTraversed (TraverseEvent event) {
				if (event.detail == SWT.TRAVERSE_TAB_NEXT) 
					resetEditors ();
				if (event.detail == SWT.TRAVERSE_RETURN) {
		...
		marginBottom.addTraverseListener(new TraverseListener() {
       		public void keyTraversed (TraverseEvent event) {
				if (event.detail == SWT.TRAVERSE_TAB_NEXT) 
					resetEditors ();
				if (event.detail == SWT.TRAVERSE_RETURN) {
		...
		spacing.addTraverseListener(new TraverseListener() {
       		public void keyTraversed (TraverseEvent event) {
				if (event.detail == SWT.TRAVERSE_TAB_NEXT) 
					resetEditors ();
				if (event.detail == SWT.TRAVERSE_RETURN) {
	 ...
	 */
	String getTabText () {
		return LayoutExample.getResourceString ("RowLayout");
	}
