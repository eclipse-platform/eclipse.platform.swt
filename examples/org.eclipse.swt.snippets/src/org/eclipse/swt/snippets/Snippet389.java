 ...
 * 
 * @see org.eclipse.swt.graphics.Image#Image(org.eclipse.swt.graphics.Device, java.io.InputStream)
 * @see org.eclipse.swt.graphics.Image#Image(org.eclipse.swt.graphics.Device, String)
 * @see org.eclipse.swt.graphics.Image#Image(org.eclipse.swt.graphics.Device, org.eclipse.swt.graphics.ImageFileNameProvider)
 * 
 * <p>
...
public class Snippet389 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String imgPath = "gef.svg";
        Path fullPath = Path.of(Snippet389.class.getResource(imgPath).toURI());
        
        // Image loaded in stream
        Image image1 = new Image(display, Snippet389.class.getResourceAsStream(imgPath));
